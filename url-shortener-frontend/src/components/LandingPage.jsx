...
const LandingPage = () => {
  ...
  return (
    <div className="min-h-[calc(100vh-196px)] lg:px-14 sm:px-8 px-4">
        ...
        <div className="flex-1">
          ...
          <div className="flex items-center gap-3">
            <motion.button
              ...
              className="cursor-pointer bg-custom-gradient w-40 text-white rounded-md py-2"
            >
              Manage Links
            </motion.button>
            <motion.button
              ...
              transition={{ duration: 0.8 }}
              onClick={dashBoardnavigateHandler}
              className="cursor-pointer border-btnColor border w-40 text-btnColor rounded-md py-2"
            >
              Create Short Link
            </motion.button>
          </div>
      ...
      <div className="sm:pt-12 pt-7">
        ...
        >
          Trusted by individual and teams at the world best companies{" "}
        </motion.p>
        <div className="pt-4 pb-7 grid lg:gap-7 gap-4 xl:grid-cols-4 lg:grid-cols-3 sm:grid-cols-2 grid-cols-1 mt-4">
          <Card
            title="Simple URL Shortening"
            desc="Explore the ease of creating short, memorable URLs in just a few clicks. Our intuitive interface and quick setup process ensure you can start shortening URLs without any hassle."
          />
          <Card
